      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-x-hidden">
        ...
        <main className="flex-1 p-4 lg:p-6 overflow-y-auto overflow-x-hidden">
          <div className="max-w-7xl mx-auto w-full">
            ...
            {/* Balance Trend Chart */}
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6 overflow-x-hidden">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Balance Trend</h2>
              {balanceTrendData.length > 0 ? (
                <div className="h-64 w-full overflow-x-hidden">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex flex-row justify-between items-center gap-4 mb-4">
                <h2 className="text-xl font-semibold text-gray-900 flex-shrink-0">Recent Transactions</h2>
                <button
                  onClick={() => router.push('/transactions')}
                  className="px-3 sm:px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors text-sm sm:text-base whitespace-nowrap flex-shrink-0"
                >
                  + Add Transaction
                </button>
              </div>
