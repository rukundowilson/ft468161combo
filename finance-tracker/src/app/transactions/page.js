            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-x-hidden">
                ...
                <div className="max-w-6xl mx-auto w-full">
                    ...
                    <div className="flex flex-col sm:flex-row justify-end gap-3 mb-6">
                        <button
                            className="px-3 sm:px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 text-sm sm:text-base whitespace-nowrap"
                        >
                        ...
                        <button
                            ...
                            className="px-3 sm:px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors flex items-center justify-center gap-2 text-sm sm:text-base whitespace-nowrap"
                        >
                            <span>+</span>
                    ...
                    {/* Filters Section */}
                    <div className="bg-gray-50 rounded-lg shadow-sm p-4 mb-6 overflow-x-hidden">
                    ...
                    <div className="space-y-3 overflow-x-hidden">
                        {filteredTransactions.length === 0 ? (
                            ...
                            filteredTransactions.map((transaction) => (
                                <div
                                    key={transaction.id}
                                    className="bg-white rounded-lg shadow-sm p-4 transition-shadow overflow-x-hidden"
                                >
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                                        ...
                                        <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto justify-between sm:justify-end">
                                            <div className="text-left sm:text-right">
                                                ...
                                                <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full mt-1 whitespace-nowrap ${
                                                    transaction.type === 'income'
